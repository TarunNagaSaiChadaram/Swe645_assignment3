...
# <!--The Student Survey Spring Boot application is developed using a multi-stage Dockerfile. 
The first stage utilizes Maven to build the application, and the second stage uses OpenJDK 17 to run the generated JAR-->
